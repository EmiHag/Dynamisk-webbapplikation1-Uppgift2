  ...
  const template = `
    ...
    <div class="p-2">
      <div>
        ...
        <span class="plus float-end" title="Lägg till plagg"><i class="bi bi-plus-square"></i></span>
        <span class="minus float-end me-2" title="Ta bort plagg"><i class="bi bi-dash-square-fill"></i></span>
      </div>
      <div class="price"></div>
      <div class="unit"></div>
...
function filterByCategory(category) {
  ...
  filteredItems.forEach(renderSingleItem);
}
